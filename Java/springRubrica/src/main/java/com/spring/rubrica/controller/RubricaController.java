...
//Controller_Contatto
	...
	public ContattoDTO ModificaContatto(@PathVariable int idRubrica, @PathVariable Integer id,
			@RequestBody ContattoNoIdDTO dto) {
	...
	public List<ContattoNomeCognomeDTO> visualizzaConGruppo(@PathVariable Integer idRubrica,
			@PathVariable String gruppo) {
